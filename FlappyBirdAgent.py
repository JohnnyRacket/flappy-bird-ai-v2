...
import random
from rl_agent.BirdNet import BirdNet
...
class Bird:
    ...
    def save(self):
        save_path = (
            self.save_dir / f"bird_net_{int(self.curr_step // self.save_every)}.chkpt"
        )
        torch.save(
            dict(model=self.net.state_dict(), exploration_rate=self.exploration_rate),
            save_path,
        )
        print(f"BirdNet saved to {save_path} at step {self.curr_step}")
